...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "GoogleMobileAds",
      url:
        "https://dl.google.com/googleadmobadssdk/5c09cf65184e1e25/googlemobileadsios-spm-9.14.0.zip",
      checksum: "5c09cf65184e1e25e508ca641550910a175a0e3e0aa57e43f58c1e3a4085e5cc"
    ),
  ]
)
